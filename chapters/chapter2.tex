...
\end{align}
where $U$ is the control input and $\beta$ is the uncertain parameter. If it is supposed that $\beta$ is known, the ideal control input would be
\begin{equation}
...
\begin{figure*}[htbp]
	...
	\begin{subfigure}{0.5\textwidth}
		...
		\caption{$\hat{z}$ is estimated online.}
	\end{subfigure}
